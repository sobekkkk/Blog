...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/sobekkkk',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'Sobek',
  bio: 'Full-Stack junior developer, infosec student & beginner ctf player',
  links: [
    // {
    //   name: 'Twitter',
